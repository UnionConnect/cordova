...
module.exports.check_requirements = function(project_root) {
    ...
    child_process.exec(command, function(err, output, stderr) {
        ...
        if (err) {
            ...
            if (output.indexOf('android-19') == -1) {
                d.reject(new Error('Please install Android target 19 (the Android 4.4 SDK). Make sure you have the latest Android tools installed as well. Run `android` from your command-line to install/update any missing SDKs or tools.'));
            } else {
                ...
                var cmd = 'android update project -p "' + framework_path  + '" -t android-19';
